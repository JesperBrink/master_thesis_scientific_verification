...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Create plots of F1 score for different values of k for the overall-top-k idea")
    parser.add_argument(
        "result_folder", metavar="path", type=str, help="the path to the results"
    )
    parser.add_argument(
        "title", type=str, help="the title of the plot"
    )
